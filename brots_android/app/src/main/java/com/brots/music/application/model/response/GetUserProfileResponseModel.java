...
import com.brots.music.application.model.responseData.GetUserProfileDataModel;
...
public class GetUserProfileResponseModel {
    ...
    @SerializedName("data")
    @Expose
    private GetUserProfileDataModel data;
    ...
    public GetUserProfileDataModel getData() {
        return data;
    }

    public void setData(GetUserProfileDataModel data) {
        this.data = data;
    }
}
