...
public class ArtistGetSongDataModel {
    @SerializedName("id")
    @Expose
    private Integer id;
    @SerializedName("Name")
    ...
    @Expose
    private List<Object> likedUser = null;
    @SerializedName("SaveAdminUser")
    @Expose
    private List<Object> saveAdminUser = null;
    ...
    public List<Object> getLikedUser() {
        return likedUser;
    }

    public void setLikedUser(List<Object> likedUser) {
        this.likedUser = likedUser;
    }

    public List<Object> getSaveAdminUser() {
        return saveAdminUser;
    }

    public void setSaveAdminUser(List<Object> saveAdminUser) {
