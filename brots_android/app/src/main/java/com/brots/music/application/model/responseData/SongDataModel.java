...
public class SongDataModel {
    ...
    @SerializedName("IsSongFullyUploaded")
    @Expose
    private String isSongFullyUploaded;
    ...
    @SerializedName("likedUser")
    @Expose
    private List<SongLikedDataModel> likedUser = null;
    @SerializedName("SaveAdminUser")
    @Expose
    private List<SaveAdminUser> saveAdminUser = null;
    @SerializedName("SongHearedByUser")
    @Expose
    private List<SongHearedByUser> songHearedByUser = null;
    ...
    public String getIsSongFullyUploaded() {
        return isSongFullyUploaded;
    }

    public void setIsSongFullyUploaded(String isSongFullyUploaded) {
        this.isSongFullyUploaded = isSongFullyUploaded;
    }
    ...
    public List<SongLikedDataModel> getLikedUser() {
        return likedUser;
    }

    public void setLikedUser(List<SongLikedDataModel> likedUser) {
        this.likedUser = likedUser;
    }

    public List<SaveAdminUser> getSaveAdminUser() {
        return saveAdminUser;
    }

    public void setSaveAdminUser(List<SaveAdminUser> saveAdminUser) {
        this.saveAdminUser = saveAdminUser;
    }

    public List<SongHearedByUser> getSongHearedByUser() {
        return songHearedByUser;
    }

    public void setSongHearedByUser(List<SongHearedByUser> songHearedByUser) {
        this.songHearedByUser = songHearedByUser;
    }
